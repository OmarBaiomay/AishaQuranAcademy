...
const RegistrationForm = () => {
  ...
  const handleUserTypeChange = (value) => {
    setFormData(prev => ({
      ...prev,
      userType: value,
      selectedCourse: null // Reset course when user type changes
    }));
    if (errors.userType) {
  ...
  const validateForm = () => {
    ...
    if (!formData.userType) {
      newErrors.userType = 'Please select Adult or Kid';
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <PhoneInput
              ...
              inputClass={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-green-600 focus:ring-green-500"
                />
                <label htmlFor="kid" className="ml-2 text-sm text-gray-700">
                  Kid Courses
                </label>
              </div>
            </div>
          ...
          {formData.userType && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {formData.userType === 'Kid Courses' ? 'Kid Courses' : 'Adult Courses'}
              ...
              {errors.selectedCourse && (
                <p className="mt-1 text-sm text-red-500">{errors.selectedCourse}</p>
              )}
            </div>
          )}
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              When Do You Want To Start Your Free Trial?
            </p>
            {errors.startDate && (
          ...
          <div>
            <div className="flex items-start">
              <input
                ...
                onChange={handleInputChange}
                className={`w-4 h-4 mt-1 text-green-600 focus:ring-green-500 rounded ${
